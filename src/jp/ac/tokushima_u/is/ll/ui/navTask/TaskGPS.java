...
import jp.ac.tokushima_u.is.ll.ui.nav.LightNav;
...
class TaskGPS extends CameraTask {
...
class MyLocationListener implements LocationListener {
	...
	MyLocationListener(CameraTask Nav, float minDiStance) {
		this.CNav = Nav;
		context = CNav.getApplicationContext();
		// Create Overlay Text Message
