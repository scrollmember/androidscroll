...
import jp.ac.tokushima_u.is.ll.ui.navTask.Task_main.TestThread;
...
public class Taskscript_select extends MapActivity implements OnClickListener,
...
//		taskscript1.removeCallbacks(null);
//		place2.removeCallbacks(null);
//		time.removeCallbacks(null);
//		timename.removeCallbacks(null);
...
//			thread.start();
	...
	private void info() {
		...
		SharedPreferences gpsdata = getSharedPreferences("taskandtaskscript", Activity.MODE_PRIVATE);  
		editor = gpsdata.edit();
	...
	private void Navigator_map() {
		...
		if (location != null) {
			...
			Toast.makeText(Taskscript_select.this,
	...
	public void onClick(View v) {
		...
		case R.id.navigatorbutton:
			Intent logintent = new Intent(Taskscript_select.this,
					Task_main.class);
			...
			Taskscript_select.this.startActivity(logintent);
			naviController.stop();
			this.finish();
			break;
...
//		super.onLowMemory();
//
//		Log.d("メモリー解放", "application memory warning!!!");
//	}
