package jp.ac.tokushima_u.is.ll.ui.nav.qr;
...
/**
 * @author Kousuke Mouri
 */

public class qr_codeMain extends Activity implements SurfaceHolder.Callback,
	...
	/** * カメラのプレビューサイズ・画面サイズを設定 * @param camera */
	...
	/**
	 * * 最適なプレビューサイズを設定 * @param parameters * @param screenPoint * @param
	 * portrait * @return
	 */
