...
public class ChangeTaskscript_select2 extends MapActivity implements
...
//		finish();
	...
	private void Navigator_map() {
		...
		if (location != null) {
			...
			Toast.makeText(ChangeTaskscript_select2.this,
	...
	public void onClick(View v) {
		...
		case R.id.navigatorbutton:
			System.gc();
			Intent logintent = new Intent(ChangeTaskscript_select2.this,Task_main.class);
			...
			this.finish();
			naviController.stop();
			ChangeTaskscript_select2.this.startActivity(logintent);
