...
public class NotifyingAsyncQueryHandler extends AsyncQueryHandler {
    ...
    private WeakReference<AsyncBatchListener> bListener;
    ...
    public interface AsyncBatchListener {
    ...
    public NotifyingAsyncQueryHandler(ContentResolver resolver, AsyncBatchListener listener) {
        super(resolver);
        setbListener(listener);
    }

    
    public void setbListener(AsyncBatchListener bListener) {
		this.bListener = new WeakReference<AsyncBatchListener>(bListener);
	}
	...
	protected void onInsertComplete(int token, Object cookie, Uri uri) {
    	 final AsyncBatchListener listener = bListener == null ? null : bListener.get();
         if (listener != null) {
