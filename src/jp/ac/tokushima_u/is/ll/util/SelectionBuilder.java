...
//    public SelectionBuilder orwhere(String selection1,  String selection2, String... selectionArgs2) {
//        if (TextUtils.isEmpty(selection)) {
//            if (selectionArgs != null && selectionArgs.length > 0) {
//                throw new IllegalArgumentException(
//                        "Valid selection required when including arguments=");
...
//    }
     ...
     */
    public Cursor query(SQLiteDatabase db, String[] columns, String groupby, String orderBy) {
