...
public class MatrixImageView extends ImageView implements OnTouchListener {
    ...
    static class Line {
        ...
        /**
         * 2つのLineインスタンスの交点を表わすPointインスタンスを取得する 交点がない場合はnullを返す
         * 
         * @param line
         * @return
         */
        ...
        public float getAngle(Line line) {
            PointF vector1 = this.getVector();
            PointF vector2 = line.getVector();
            return (float) Math.atan2(vector1.x * vector2.y - vector1.y * vector2.x, vector1.x
        ...
        /**
         * 交点までのベクトルを p1 + n * (p2 - p1) であらわしたとき、 nが適切な値の範囲内かどうかを判定する。
         * 直線の場合：nはどの値でもよい 半直線の場合：nは0以上である必要がある 線分の場合：nは0以上1以下である必要がある
         * 
         * @param n
         * @return
         */
